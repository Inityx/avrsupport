...
namespace AvrSupport::Mapping {
    ...
    private:
        static Utility::Array<Encoding, 36> const CHARS;
        static size_t const ALPHA_OFFSET = 10;
    ...
    Utility::Array<SevenSegmentMap::Encoding, 36> const
    SevenSegmentMap::CHARS = {
        //. abcdefg
        0b0'1111110, // 0
        0b0'0110000, // 1
        0b0'1101101, // 2
    ...
    using SevenSegmentFrom = CharMapper<SevenSegmentMap>;
}
#endif